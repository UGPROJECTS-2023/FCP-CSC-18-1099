...
<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Vehicle Plate Number</a>
        </div>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            	...
            	<input type="text" name="name" class="form-control" placeholder="Enter Owner's Name" maxlength="50" value="<?php echo $name ?>" />
                </div>
            ...
            <div class="form-group">
            	...
            	<input type="text" name="address" class="form-control" placeholder="Enter Contact Address" maxlength="40" value="<?php echo $address ?>" />
                </div>
            ...
            <div class="form-group">
            	...
            	<input type="text" name="phone" class="form-control" placeholder="Enter Phone (starting with 234)" maxlength="40" value="<?php echo $phone ?>" />
                </div>
            ...
            <div class="form-group">
            	...
            	<input type="text" name="occupation" class="form-control" placeholder="Enter Occupation" maxlength="40" value="<?php echo $occupation ?>" />
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="dlReg" class="form-control" placeholder="Enter Drivers Licence Registration Number" maxlength="40" value="<?php echo $dlReg ?>" />
                </div>
            ...
            <div class="form-group">
            	<div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-flag"></span></span>
            	<input type="text" name="vehicleName" class="form-control" placeholder="Enter Vehicle Name" maxlength="40" value="<?php echo $vehicleName ?>" />
                </div>
            ...
            <div class="form-group">
            	...
            	<input type="text" name="vehicleModel" class="form-control" placeholder="Enter Vehicle Model" maxlength="40" value="<?php echo $vehicleModel ?>" />
                </div>
            ...
            <div class="form-group">
            	...
            	<input type="text" name="vehicleReg" class="form-control" placeholder="Enter Vehicle Registration Number" maxlength="40" value="<?php echo $vehicleReg ?>" />
                </div>
            ...
            <div class="form-group">
                <div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-search"></span></span>
                <input type="text" name="vehicleEngine" class="form-control" placeholder="Enter Vehicle Engine Number" maxlength="40" value="<?php echo $vehicleEngine ?>" />
                </div>
            ...
            <div class="form-group">
            	...
            	<input type="text" name="vehiclePlate" class="form-control" placeholder="Enter Vehicle Plate Number" maxlength="40" value="<?php echo $vehiclePlate ?>" />
                </div>
